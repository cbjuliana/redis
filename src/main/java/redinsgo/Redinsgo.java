	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int i = 1; i < 100; i++) {
				...
				jedis.sadd("numeros", String.valueOf(i));
			...
			while (bingo != true) {
				...
				for (int i = 1; i <= 50; i++) {
					 ...
					 if (jedis.sismember("cartela" + i, numeroSorteado)) {
						 ...
						 System.out.println("User" + i + " ACERTOU o número: " + numeroSorteado + " SCORE: " + jedis.zscore("score", "score" + i));
		                 ...
		                 if (jedis.zscore("score", "score" + i) == 15) {
		                	...
		                	bingo = true;
		                 	...
		                 	System.out.println("User" + i + " fez BINGOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO!!!!!!!!!");
